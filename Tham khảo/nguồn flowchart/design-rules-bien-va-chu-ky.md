...
Trong mỗi file command flow của từng layer, phải đưa mục biến do layer đó tạo ra lên đầu file, trước phần flow chi tiết. Mục này chỉ được liệt kê các biến thật sự được layer đó tạo ra hoặc cập nhật, không trộn biến vào và biến dùng.
